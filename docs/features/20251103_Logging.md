...
**Root Cause:** `Directory.GetCurrentDirectory()` unreliable in Azure App Service

**Fix:** Updated `SmtpEmailService.cs` to:
...
**Files Changed:** [SmtpEmailService.cs](../src/Ocelis.Configurator.BlazorApp/Services/SmtpEmailService.cs)
